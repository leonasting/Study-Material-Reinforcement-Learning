...
class PolicyNetwork(nn.Module):
    """
    Core Class to act as a policy network
    """
...
class PolicyGradientAgent():
    """
    Has its own policy network.

    Functions:
    choose_action - choose an action based on the policy network
    store_rewards - store the rewards
    learn - learn from the rewards
