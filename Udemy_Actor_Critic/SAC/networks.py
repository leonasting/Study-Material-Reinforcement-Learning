...
from torch.distributions.normal import Normal# Stocastic Action
import numpy as np
...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions,
        ...
        self.fc1 = nn.Linear(self.input_dims[0] + n_actions, self.fc1_dims)# Takes input state and action taken
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, max_action,
        ...
        self.checkpoint_dir = chkpt_dir
        self.checkpoint_file = os.path.join(self.checkpoint_dir, name+'_sac')
        self.reparam_noise = 1e-6 # for numerical stability hardcoded noise
